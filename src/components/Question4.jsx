  ...
  return (
    <form action className="form">
      ...
      <div className="qa-container normal-radio">
        ...
        <input type="radio" id="q-4-1" name="temperature" value="1" onClick={(e)=>{
            props.onClick(e.target.name, e.target.value)
          }} />
        <label htmlFor="q-4-1">
          <span>추울 때는 영하로도 떨어져요.</span>
        </label>
        <input type="radio" id="q-4-2" name="temperature" value="2" onClick={(e)=>{
            props.onClick(e.target.name, e.target.value)
          }} />
        <label htmlFor="q-4-2">
          <span>영하는 아니지만 10도 이하로 떨어지기도 해요.</span>
        </label>
        <input type="radio" id="q-4-3" name="temperature" value="3" onClick={(e)=>{
            props.onClick(e.target.name, e.target.value)
          }} />
        <label htmlFor="q-4-3">
