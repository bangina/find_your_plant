    ...
    <form action className="form">
      ...
      <div className="qa-container">
        ...
        <div className="a-box">
          ...
          <input type="radio" id="q-1-1" name="space" value="1" onClick={(e)=>{
        ...
        <div className="a-box">
          ...
          <input type="radio" id="q-1-2" name="space" value="2" onClick={(e)=>{
            props.onClick(e.target.name, e.target.value)
          }} />
          <label htmlFor="q-1-2">
            <span>방</span>
        ...
        <div className="a-box">
          ...
          <input type="radio" id="q-1-3" name="space" value="3" onClick={(e)=>{
            props.onClick(e.target.name, e.target.value)
          }} />
          <label htmlFor="q-1-3">
            <span>거실</span>
        ...
        <div className="a-box">
          <input type="radio" id="q-1-4" name="space" value="4" onClick={(e)=>{
            props.onClick(e.target.name, e.target.value)
          }} />
          <label htmlFor="q-1-4">
