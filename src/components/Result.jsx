...
const Result = () => {
  ...
  const template = {
    ...
    content: {
      ...
      description: "우리집/사무실에 알맞는 식물 찾기!",
      imageUrl: "http://iina.dothome.co.kr/find_your_plant/imgs/key_image.png",
      link: {
        ...
        <SwiperSlide>
          <div className="container result">
            ...
            <ul className="conditions">
              ...
              <li>
                ...
                <div className="step-container step-container-thin">
                  <div
                    className="step"
                    style={{ width: firstPlant.size * 40 }}
                  />
                  <div className="step-bg" />
                </div>
            ...
            <KakaoLinkDefault
              className="template"
              template={template}
              jsKey={"8962f6a7337cced572eed6fa07951af9"}
            >
              <button>#find_your_plant 공유하기</button>
            </KakaoLinkDefault>
            {/* 다른 식물 후보 */}
            ...
            <ul className="conditions">
              ...
              <li>
                ...
                <div className="step-container step-container-thin">
                  ...
                  <div
                    className="step"
                    style={{ width: thirdPlant.size * 40 }}
                  />
                  <div className="step-bg" />
                </div>
